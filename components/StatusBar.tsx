...
const StatusBar: React.FC = () => {
  ...
  useEffect(() => {
    if (isNative) {
      ...
      // CapStatusBar.setBackgroundColor({ color: '#FFFFFF' }); // Optional, depends on design
    }
  }, [isNative]);
  ...
  // On native iOS/Android, the system status bar is already visible. 
  // We don't want to duplicate it with a fake one.
